...
| `month.test.js` | Dat er geen maandnavigatie meer is, dat de kop de lopende maand toont, dat de berekening per maand wél is blijven bestaan voor de vooruitblikpagina, en de rolwissel: met een nepklok van 31 januari 23:30 naar februari, zonder dat er iets wordt aangeraakt. |
