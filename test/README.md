...
| `reminder.test.js` | De herinneringsbalk op een nepklok: de grens van zeven dagen precies, wat er nog openstaat, afvinken vanuit de balk, en het oranje bolletje met de verwijzing in het menu. |
